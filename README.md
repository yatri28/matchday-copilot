...
| **Accessibility** | A **voice assistant** (speak your question, hear answers read aloud — in your language), a "step-free routes" mode that guarantees wheelchair users are never routed through stairs-only areas, mapped sensory room and accessible restrooms, and a WCAG-minded UI (ARIA live regions, skip link, keyboard focus, reduced-motion support) |
...
- Tap the **🎤 mic button** and speak your question — recognition uses your selected language; enable **Read answers aloud** for spoken replies (Web Speech API; mic works in Chrome/Edge and hides itself on unsupported browsers)
